...
const Scanner = ({ onArticleClick }) => {
  ...
  const mockResults = {
    ...
    ingredients: [
      ...
      },
      {
        name: "Organic honey",
        status: "moderate",
        reason: "Natural sweetener, consume in moderation",
      },
      { name: "Sea salt", status: "good", reason: "Minimal sodium content" },
      {
        name: "Vitamin D",
        status: "good",
        reason: "Essential nutrient fortification",
      },
    ],
    nutrition: {
      calories: 150,
    ...
    cons: ["Contains added sugars", "Moderate sodium content"],
    alternatives: [
  ...
  const generateAIResponse = (question) => {
    const responses = {
      default:
        "Based on the analysis, this product has a health score of 8.2/10. It's a good choice due to its whole grain content and minimal processing. Would you like me to explain any specific aspect?",
      ingredients:
        "The main ingredients are whole grain oats (excellent for fiber), organic honey (natural but still sugar), and sea salt (minimal amount). The vitamin D fortification is beneficial for bone health.",
      alternatives:
        "For even healthier options, try steel-cut oats with fresh berries, homemade granola with nuts and seeds, or a quinoa breakfast bowl with fruits. These provide similar nutrition with less added sugars.",
      health:
        "This cereal supports digestive health with 4g of fiber per serving and provides sustained energy from whole grains. The 5g of protein helps with satiety. Just watch the 6g of added sugars.",
    };
  ...
  return (
    <section
      id="scanner"
      className="py-20 bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 min-h-screen"
    >
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Experience the power of AI-driven food analysis. Sign in to scan
            product labels and get instant health insights.
          </p>
        </div>
                ...
                {currentStep === "auth" && (
                  <div className="p-8 text-center">
                    ...
                    <p className="text-gray-600 mb-8">
                      Before you can scan any product label, you need to sign in
                      to your FX Health account.
                    </p>
                  ...
                  <div className="p-8">
                    <div className="text-center mb-8">
                      ...
                      <p className="text-gray-600">
                        Take a photo or upload an image of any food product
                        label
                      </p>
                    </div>
                ...
                {currentStep === "scanning" && (
                  <div className="p-8">
                    <div className="text-center mb-8">
                      ...
                      <p className="text-gray-600">
                        Our AI is processing the label and ingredients
                      </p>
                    </div>
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            <p className="text-purple-800 font-medium">
                              🔒 Advanced AI insights locked
                            </p>
                            <p className="text-purple-600 text-sm">
                              Get detailed nutrition analysis with Premium
                            </p>
                          </div>
                          <button
                            onClick={() => setIsSubscriptionOpen(true)}
                ...
                {currentStep === "results" && analysisResults && (
                  <div className="p-8">
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          <h4 className="text-xl font-bold text-gray-900 mb-2">
                            {analysisResults.productName}
                          </h4>
                          <div className="flex items-center space-x-3">
                            <span
                              className={`px-4 py-2 rounded-full text-sm font-medium bg-${analysisResults.verdictColor}-100 text-${analysisResults.verdictColor}-700`}
                            >
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 mb-6">
                      {Object.entries(analysisResults.nutrition).map(
                        ([key, value]) => (
                          <div
                            key={key}
                    ...
                    <div className="grid md:grid-cols-2 gap-6 mb-6">
                      <div className="bg-emerald-50 rounded-xl p-6">
                        ...
                        <ul className="space-y-2">
                          {analysisResults.pros.map((pro, index) => (
                            <li
                              key={index}
                              className="text-emerald-700 text-sm flex items-start"
                            >
                      ...
                      <div className="bg-amber-50 rounded-xl p-6">
                        ...
                        <ul className="space-y-2">
                          {analysisResults.cons.map((con, index) => (
                            <li
                              key={index}
                              className="text-amber-700 text-sm flex items-start"
                            >
                      ...
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-amber-600 text-xs">
                            3 scans/day • Basic insights only
                          </p>
                        </div>
                        <button
                          onClick={() => setIsSubscriptionOpen(true)}
                ...
                {chatMessages.length === 0 && (
                  <div className="text-center py-8">
                    ...
                    <p className="text-gray-600 mb-4">
                      Hi! I'm your AI health assistant. Ask me about:
                    </p>
                    <div className="grid grid-cols-2 gap-2 text-sm">
                      <button
                        onClick={() =>
                          setChatInput("Tell me about the ingredients")
                        }
                      ...
                      <button
                        onClick={() =>
                          setChatInput("What are healthier alternatives?")
                        }
                      ...
                      <button
                        onClick={() =>
                          setChatInput("Health benefits and concerns?")
                        }
                      ...
                      <button
                        onClick={() =>
                          setChatInput("Is this good for weight loss?")
                        }
